...
public class LeaveDetailDAO {
	...
	public static List<LeaveDetail> findByUserId(String userName) throws DatabaseException {
		log.debug("findByUserId({})", userName);
	...
	public static List<LeaveDetail> findPendingLeave(String approverName) throws DatabaseException {
		...
		String qs = "from LeaveDetail a where a.approverName=:approverName";
